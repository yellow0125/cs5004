...
public interface MarbleSolitaireModel {
  ...
  /**
   * Determine and return if the chess piece can move or not.
   *
   * @param row the row number of the position of one chess piece
   * @param col the column number of the position of one chess piece
   * @return true if the chess piece can move, false otherwise
   * @throws IllegalArgumentException if the move is not possible
   */
